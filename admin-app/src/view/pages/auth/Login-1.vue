  ...
  <div class="d-flex flex-column flex-root">
    ...
    >
      ...
      <!-- <div
        ...
        style="background-color: #00923cb0;"
      >
        <div class="d-flex flex-column-auto flex-column pt-lg-40 pt-15">
          <a href="#" class="text-center mb-10">
            <img
              src="/media/logos/naseni_logo.png"
              class="max-h-100px"
              alt=""
            />
          </a>
...
<!--                <a href="#" class="text-center" style="margin-left: 35%">-->
<!--                  <img-->
...
<!--                </a>-->
                <h3
                  class="font-weight-bolder text-dark font-size-h4 mt-4 font-size-h1-lg"
                >
...
export default {
  ...
  computed: {
    ...
    backgroundImage() {
      return process.env.BASE_URL + "media/users/documents.png";
    }
  },
  methods: {
    showForm(form) {
